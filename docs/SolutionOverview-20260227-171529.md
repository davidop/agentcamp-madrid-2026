...
graph TB
    ...
    %% Dependencies
    apiservice -->|uses| apiservice
    apiservice -->|uses| cache
    apiservice -->|uses| apiservice
    ...
    class apiservice,webfrontend,apiservice,webfrontend service
    class sql,cache resource
```
...
sequenceDiagram
    ...
    apiservice->>+cache: health check
    cache-->>-apiservice: healthy ✅
...
|----------|-------|
| Files scanned | 22 |
| Timestamp | 2026-02-27T17:15:29.188462 |
| Services detected | 4 |
| Resources detected | 2 |
...
*Generated automatically by `pipeline.py` on 20260227-171529*
